# -*- coding: utf-8 -*-
"""
Copia do flow template para dump de URL
"""
...
from pipelines.rj_escritorio.dump_url_formacao.schedules import gsheets_schedule

formacao_dump_gsheets_flow = deepcopy(dump_url_flow)
formacao_dump_gsheets_flow.name = "Formação Exemplo: Ingerir CSV"
