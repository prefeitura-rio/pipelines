...
ergon_queries = {
    ...
    "licenca_afastamento": {
        ...
        "dump_mode": "append",
        "execute_query": """
        SELECT NUMFUNC,NUMVINC,DTINI,DTFIM,TIPOFREQ,CODFREQ,MOTIVO,DTPREVFIM,FLEX_CAMPO_01,FLEX_CAMPO_02,EMP_CODIGO,FLEX_CAMPO_07
    ...
    "vantagens": {
        ...
        "dump_mode": "append",
        "execute_query": """
        SELECT NUMFUNC,NUMVINC,VANTAGEM,DTINI,DTFIM,VALOR,INFO,TIPO_INCORPORACAO,PERC_INC_FUNCAO,INC_TABELAVENC,INC_REFERENCIA,PERC_INC_GRAT_FUNCAO,INC_GRAT_TABVENC,INC_GRAT_REFERENCIA,OBS,VALOR2,INFO2,VALOR3,INFO3,VALOR4,INFO4,VALOR5,INFO5,VALOR6,INFO6,FLEX_CAMPO_05,EMP_CODIGO,CHAVEVANT
    ...
    "total_contagem": {
        ...
        "dump_mode": "overwrite",
        "execute_query": """
        SELECT CHAVE, NUMFUNC,NUMVINC,FINALIDADE,DIASTOT,DIASFPUB,DIASFPUBESP,TOTAL_PERIODOS,TOTAL_ANOS,DATA_PROXIMO,NOME_PROXIMO,EMP_CODIGO
    ...
    "averbacoes": {
        ...
        "dump_mode": "overwrite",
        "execute_query": """
        SELECT NUMFUNC,NUMVINC,CHAVE,DTINI,DTFIM,INSTITUICAO,TIPOTEMPO,DATA_A_CONTAR,TOTAL_DIAS,MOTIVO,SOBREPOE,EMP_CODIGO,OBS,REGPREV
    ...
    "tipo_tempo": {
        ...
        "dump_mode": "overwrite",
        "execute_query": """
        SELECT SIGLA, NOME, APOSENTADORIA, FERIAS, DIAS_FER, ADICTSERV, LICESP, DIAS_LICESP, ADICTCHEFIA, PROGRESSAO
