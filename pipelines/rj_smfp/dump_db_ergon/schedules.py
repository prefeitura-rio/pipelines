...
ergon_queries = {
    ...
    "vantagens": {
        ...
        "dump_mode": "append",
        "execute_query": """
        SELECT NUMFUNC,NUMVINC,VANTAGEM,DTINI,DTFIM,VALOR,INFO,TIPO_INCORPORACAO,PERC_INC_FUNCAO,INC_TABELAVENC,INC_REFERENCIA,OBS,VALOR2,INFO2,VALOR3,INFO3,VALOR4,INFO4,VALOR5,INFO5,VALOR6,INFO6,FLEX_CAMPO_05,EMP_CODIGO,CHAVEVANT
