...
from pipelines.formacao.exemplo.tasks import download_data, format_phone_number, gerar_df, salvar_df_transformado, format_phone_number, total_users, total_users_country
from pipelines.utils.decorators import Flow
from pipelines.utils.tasks import create_table_and_upload_to_gcs

with Flow("EMD: formacao - Exemplo de flow do Prefect da Stella") as formacao_example_flow:
    ...
    create_table_and_upload_to_gcs(data_path=path, dataset_id='teste_stella',
