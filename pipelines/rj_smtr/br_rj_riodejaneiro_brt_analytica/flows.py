# -*- coding: utf-8 -*-
"""
Flows for br_rj_riodejaneiro_brt_analytica
"""
...
from prefect.storage import GCS
from pipelines.constants import constants
from pipelines.rj_smtr.br_rj_riodejaneiro_brt_analytica.tasks import save_model

# from pipelines.rj_smtr.br_rj_riodejaneiro_brt_analytica.schedules import every_two_weeks
from pipelines.utils.decorators import Flow

with Flow(
    "SALVAR MODELO - MEDIANA", code_owners=["ronald", "vinicius", "joao_pedro"]
) as rj_smtr_br_rj_riodejaneiro_brt_analytica_flow:
    save_model()

rj_smtr_br_rj_riodejaneiro_brt_analytica_flow.storage = GCS(
    constants.GCS_FLOWS_BUCKET.value
)
rj_smtr_br_rj_riodejaneiro_brt_analytica_flow.run_config = KubernetesRun(
