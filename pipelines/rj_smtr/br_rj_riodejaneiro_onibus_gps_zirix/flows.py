...
from pipelines.rj_smtr.br_rj_riodejaneiro_onibus_gps_zirix.tasks import (
...
with Flow(
    ...
    filepath = create_local_partition_path(
        dataset_id=zirix_constants.GPS_SPPO_ZIRIX_RAW_DATASET_ID.value,
...
with Flow(
    ...
    raw_dataset_id = Parameter(
        "raw_dataset_id", default=zirix_constants.GPS_SPPO_ZIRIX_RAW_DATASET_ID.value
    )
    raw_table_id = Parameter(
        "raw_table_id", default=constants.GPS_SPPO_RAW_TABLE_ID.value
    )
    dataset_id = Parameter(
        "dataset_id", default=zirix_constants.GPS_SPPO_ZIRIX_RAW_DATASET_ID.value
    )
    table_id = Parameter(
        "table_id", default=zirix_constants.GPS_SPPO_ZIRIX_TREATED_TABLE_ID.value
    )
...
with Flow(
    ...
    with case(errors, True):
        ...
        filepath = create_local_partition_path.map(
            dataset_id=unmapped(zirix_constants.GPS_SPPO_ZIRIX_RAW_DATASET_ID.value),
