...
def trata_motivo(valor: dict):
    if valor == "Não respeitou o limite da conformidade da distância da viagem.":
        ...
        valor
        == "Não respeitou o limite da conformidade da quantidade de transmissões dentro do itinerário. (Art 2o Res. SMTR 3534 / 2022)"
    ):
        return "Não respeitou o limite da conformidade da quantidade de transmissões dentro do itinerário. (Art 2º Res. SMTR 3534 / 2022)"
    elif (
        valor
        == "Não houve comunicação de GPS no período informado para o veículo. (Art 1o Res. SMTR 3534 / 2022)"
    ):
        return "Não houve comunicação de GPS no período informado para o veículo. (Art 1º Res. SMTR 3534 / 2022)"
    elif (
        valor
        == "Intempestivo. Recurso de viagem fora do prazo.  (Art. 5o Res. SMTR 3534 / 2022)"
    ):
        return "Intempestivo. Recurso de viagem fora do prazo.  (Art. 5º Res. SMTR 3534 / 2022)"
    elif (
        valor
        == "Não respeitou o limite da conformidade da qualidade do GPS. (Art 2o Res. SMTR 3534 / 2022)"
    ):
        return "Não respeitou o limite da conformidade da qualidade do GPS. (Art 2º Res. SMTR 3534 / 2022)"
    elif valor == "Viagem já paga.":
        return "Viagem já paga."
    elif (
        valor
        == "Viagem identificada considerando os sinais de GPS com o serviço informado pelo recurso."
    ):
        return "Viagem identificada considerando os sinais de GPS com o serviço informado pelo recurso."
    else:
        return valor
...
def analisar_ja_julgados(row):
    """
    Analisa se o recurso já foi julgado anteriormente, se tiver sido, retira o julgamento anterior.
    """
...
def analisar_linha(row: dict) -> dict:
    ...
    # Não da para adicionar no customFieldValues, pois não da para fazer o PATCH do motivo junto com o do Julgamento
