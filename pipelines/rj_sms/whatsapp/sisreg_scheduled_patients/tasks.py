...
def save_patients(dataframe):
    ...
    partition_directory = 'pipelines/rj_sms/whatsapp/sisreg_scheduled_patients/data_partition'
    shutil.rmtree(partition_directory, ignore_errors=True)
    create_partitions('pipelines/rj_sms/whatsapp/sisreg_scheduled_patients/data', partition_directory)
    return True
