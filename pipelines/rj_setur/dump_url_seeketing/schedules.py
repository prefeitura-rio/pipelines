...
gsheets_urls = {
    "museu_do_amanha": {
        "dump_mode": "overwrite",
        "url": "https://docs.google.com/spreadsheets/d/1nzgVubRzHJuFiph1b-6h1Ck70aDi2zZX\
            /edit?pli=1#gid=861373755",
...
gsheets_clocks = generate_dump_url_schedules(
    ...
    start_date=datetime(
        2021, 12, 21, 6, 15, tzinfo=pytz.timezone("America/Sao_Paulo")
    ),
    labels=[
