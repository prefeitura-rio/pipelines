...
from pipelines.rj_cor.alagamentos.meteorologia_inmet.tasks import (slice_data, download,
                                                                   tratar_dados, salvar_dados)
from pipelines.rj_cor.alagamentos.meteorologia_inmet.schedules import hour_schedule
